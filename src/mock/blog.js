 ...
 * @Version: 1.0
 * @Author: bx.m
 * @Date: 2021-08-23 23:03:08
 * @LastEditors: bx.m
 * @LastEditTime: 2021-09-05 10:38:54
 */
...
Mock.mock("/api/blogtype", "get", {
    ...
    "data|10-20": [{
        "id|+1": 1,
        "name": "分类@id",
        "articleCount|10-20": 1, // 该分类下文章的数量
        "order|+1": 1
    }]
})
...
// + 1-多
// ？0-1
// Mock的动态模板 [`rows|${result.limit}`]


// import querystring from "querystring";
// const querystring = require("querystring");
Mock.mock(/^\/api\/blog(\?.+)?$/, "get", function (options) {
    const result = qs.parse(options.url);
    return Mock.mock({
        "code": 0, // 错误码
        "msg": "", // 错误消息
        "data": {
            "total|0-2000": 786, //总数
            [`rows|${result.limit}`]: [ // 当前页列表数据
                {
                    "id|+1": 2,
                    "title": "@ctitle(1, 50)",
                    ...
                    "scanNumber|1-200": 10,
                    "commentNumber|1-200": 30,
                    "thumb|1": [Mock.Random.image("300x250", "#abc", "#4A7BF7", "Random Image"), null],
                    createDate: `@date('T')`
                }
            ]
        }
...
// main.js中的测试代码
// import * as b from "@/api/getBlog.js";
// b.getOneBlog("aaa").then(r => console.log(r));
// b.postComment({
//   nickname: "昵称",
//   content: "评论内容，纯文本",
//   blogId: "aaa"
// }).then(r => console.log(r));
// b.getComment("aa").then(r => console.log(r))